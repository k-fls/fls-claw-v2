...
async function buildContainerArgs(
  ...
  //
  // The OneCLI gateway itself is applied AFTER the volume mounts below (so a
  // credential stub nested inside one of our mounts isn't shadowed), and only
  // when the MITM proxy is NOT the egress owner — see that block.
