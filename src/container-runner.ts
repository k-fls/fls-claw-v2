...
async function buildContainerArgs(
  ...
  // either way so host-rpc / the credential broker stay reachable. (Our fork's
  // egress-lockdown module supersedes upstream's dedicated-network approach.)
  // The OneCLI gateway itself is applied after the volume mounts below.
