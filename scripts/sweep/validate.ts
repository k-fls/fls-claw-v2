...
export async function validateRegistry(
  ...
  // Rule 5 extension (2026-07-14 scope rule, D-033 transitive-historical):
  // non-inventory branches that are part of the transitive edition
  // composition are swept (merge source: main only) but must be flagged
  // until they get an inventory entry.
